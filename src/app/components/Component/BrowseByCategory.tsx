...
export default function CategoryList() {
  return (
    ...
    <div className="grid lg:grid-cols-6 grid-cols-2 gap-4 items-center justify-between py-10 lg:py-6 lg:space-y-0 space-y-6">
    ...
    <div className="border-b-[0.5px] py-12"></div>
    </main>
  );
}